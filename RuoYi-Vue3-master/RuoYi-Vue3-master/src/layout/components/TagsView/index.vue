...
.tags-view-container {
  ...
  &:not(.tags-view-container--chrome) .tags-view-wrapper .tags-view-item.active {
    background: color-mix(in srgb, var(--current-color, #409eff) 10%, var(--el-bg-color, #fff)) !important;
    color: var(--current-color, #2563eb);
    border-color: color-mix(in srgb, var(--current-color, #409eff) 28%, transparent) !important;
    box-shadow: none;
  ...
  &.tags-view-container--chrome {
    --chrome-strip-bg: var(--admin-surface, #fff);
